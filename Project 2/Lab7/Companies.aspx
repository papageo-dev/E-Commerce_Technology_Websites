<%@ Page Title="Advanced Dbase Issues" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Companies.aspx.cs" Inherits="Companies" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        &nbsp;</p>
    <h3>Advanced&nbsp;Dbase&nbsp;Issues.</h3>
    <p>
    <br />
